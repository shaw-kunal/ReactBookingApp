...
export const Header = (props) => {
    const [calender, serCalender] = useState(false);
            ...
            { props.type !=="list" && <> <h1 className="headerTitle">A lifetime of discount ? it's genuine</h1>
                ...
                <div className="headerSearch">
                    ...
                    <div className="headerSearchItem">
                        ...
                        <span onClick={() => serCalender(!calender)} className='headerSearchText'>{`${format(date[0].startDate, "MM/dd/yyyy")} to ${format(date[0].endDate, "MM/dd/yyyy")}`}</span>
                        {calender && <DateRange
